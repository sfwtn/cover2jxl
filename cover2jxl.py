...
if extension=="webp":
    ...
    os.system(f"magick convert cover.webp -resize 1400x1400 cover-1400p.jpeg")

    originalFile = os.stat("cover.webp").st_size / 1024 /1024
    jpegFile = os.stat("cover-1400p.jpeg").st_size / 1024 /1024
    print(f"Done:\nOriginal file:\t{originalFile:.2f} MB\n1400p file:\t{jpegFile:.2f} MB")
    exit(0)
# AVIF route
elif extension=="avif":
    ...
    os.system(f"magick convert cover.avif -resize 1400x1400 cover-1400p.jpeg")
...
# JXL route
    ...
    os.system(f"magick convert cover.jxl -resize 1400x1400 cover-1400p.jpeg")
...
os.system(f"magick convert cover.{extension} -resize 1400x1400 cover-1400p.jpeg")
